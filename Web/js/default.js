...
// ----------------------------------- USER SETTINGS ---------------------------------- //
	...
	var powerUsersDelete = "<img src='images/16-delete.png' alt='Delete' class='powerUsersDelete' />";
	...
	$("#flowchartContent #copyTableButton").live("click", function () {
		...
		function(data) {
			ref.toggle().html(data).fadeIn(800, function () {
				...
				$.post('ajaxPresenca.php', {shiftWeek: weekFromNow}, 
					function(data) {
...
// 	VARS	//
	var deleteImgHtml = "<img src='images/16-delete.png' alt='Delete' class='collectionOptionsDelete' />";
