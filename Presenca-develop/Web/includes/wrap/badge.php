    ...
    function printSingleBadge($id, $name, $position, $photo, $className, $infoContainer) {
        ...
        <li class="badge <?php if ($infoContainer) { ?> infoContainer <?php } ?><?php echo $className ?>">
            <form method="post" action="#">
                ...
                <div class="badgeName"><p class="<?php if ($infoContainer) { ?> infoContainerInputContent <?php } else { ?> infoContainerTextContent <?php } ?>" title="name"><?php echo truncateName($name, 17) ?></p></div>
                <div class="badgePosition"><p class="<?php if ($infoContainer) { ?> infoContainerInputContent <?php } else { ?> infoContainerTextContent <?php } ?>" title="position"><?php echo truncateName($position, 15) ?></p></div>
